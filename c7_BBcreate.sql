...
insert into bb_shopper
    values (22, 'Margaret', 'Somners', '287 Walnut Drive', 'Cheasapeake',
...
CREATE TABLE bb_audit_logon
  ( userid VARCHAR2(10),
    logdate DATE );
UPDATE bb_basket
  SET shipfirstname='John',shiplastname='Carters',
      shipaddress='21 Front St.',shipcity='Raleigh',
      shipstate='NC',shipzipcode='54822'
   WHERE idBasket = 4;
UPDATE bb_basket
  SET shipfirstname='Margaret',shiplastname='Somnesrs',
